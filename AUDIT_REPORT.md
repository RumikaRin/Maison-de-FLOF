...
- PostgreSQL 18 test DB áp dụng đủ 8 migration và chạy 15 integration test. Migration reconciliation mới idempotent nhưng chưa được ghi vào production migration history vì chưa có approval mới.
