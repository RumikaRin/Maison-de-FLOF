...
export function SwatchChip({
  ...
  return (
    <button
      ...
      className={cn(
        "group flex min-h-11 flex-col text-left transition-transform duration-fl-fast active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-atelier-accent",
