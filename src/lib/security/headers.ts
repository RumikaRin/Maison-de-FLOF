...
export function buildContentSecurityPolicy(
  ...
  const directives = [
    ...
    "img-src 'self' blob: data: https://*.public.blob.vercel-storage.com https://res.cloudinary.com https://images.unsplash.com https://img.vietqr.io https://basemaps.cartocdn.com https://*.basemaps.cartocdn.com",
    "font-src 'self' data:",
